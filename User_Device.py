...
class UserDevice(GenericDevice):
    def __init__(self, x=0, y=0, gain=1,\
        ...
        GenericDevice.__init__(self, x=x, y=y, gain=gain, tx_power=cell_phone_tx_power, operator=operator)
    ...
    def set_initial_user_station(self, station_list):
        ...
        for station in station_list:
            sig_pow = self.calculate_signal_power(station, station.currently_used_frequencies[0])
            if sig_pow > best_pow:
                best_pow = sig_pow
